from .connection import BaseConnection as BaseConnection
...
class _Auth:
    def __init__(self, oidc_config: OIDC_CONFIG, credentials: AuthCredentials, connection: BaseConnection) -> None: ...
