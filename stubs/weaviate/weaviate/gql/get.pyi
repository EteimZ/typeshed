...
from weaviate.gql.filter import Ask as Ask, Filter as Filter, GraphQL as GraphQL, NearImage as NearImage, NearObject as NearObject, NearText as NearText, NearVector as NearVector, Sort as Sort, Where as Where
from weaviate.types import UUID as UUID
from weaviate.util import get_valid_uuid as get_valid_uuid, image_encoder_b64 as image_encoder_b64
...
class Hybrid:
    ...
    properties: Optional[List[str]]
    def __init__(self, query, alpha, vector, properties) -> None: ...
...
class GetBuilder(GraphQL):
    ...
    def with_hybrid(self, query: str, alpha: Optional[float] = ..., vector: Optional[List[float]] = ..., properties: Optional[List[str]] = ...): ...
