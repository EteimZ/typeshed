...
from weaviate.gql.filter import VALUE_ARRAY_TYPES as VALUE_ARRAY_TYPES, WHERE_OPERATORS as WHERE_OPERATORS
...
class Batch:
    ...
    def configure(self, batch_size: Optional[int] = ..., creation_time: Optional[Real] = ..., timeout_retries: int = ..., connection_error_retries: int = ..., weaviate_error_retries: Optional[WeaviateErrorRetryConf] = ..., callback: Optional[Callable[[List[dict]], None]] = ..., dynamic: bool = ..., num_workers: int = ..., consistency_level: Optional[ConsistencyLevel] = ...) -> Batch: ...
    def add_data_object(self, data_object: dict, class_name: str, uuid: Optional[UUID] = ..., vector: Optional[Sequence] = ..., tenant: Optional[str] = ...) -> str: ...
    def add_reference(self, from_object_uuid: UUID, from_object_class_name: str, from_property_name: str, to_object_uuid: UUID, to_object_class_name: Optional[str] = ..., tenant: Optional[str] = ...) -> None: ...
    def create_objects(self) -> list: ...
    def create_references(self) -> list: ...
    def flush(self) -> None: ...
    def delete_objects(self, class_name: str, where: dict, output: str = ..., dry_run: bool = ..., tenant: Optional[str] = ...) -> dict: ...
