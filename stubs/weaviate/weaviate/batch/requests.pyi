...
class ReferenceBatchRequest(BatchRequest):
    def add(self, from_object_class_name: str, from_object_uuid: UUID, from_property_name: str, to_object_uuid: UUID, to_object_class_name: Optional[str] = ..., tenant: Optional[str] = ...) -> None: ...
...
class ObjectsBatchRequest(BatchRequest):
    def add(self, data_object: dict, class_name: str, uuid: Optional[UUID] = ..., vector: Optional[Sequence] = ..., tenant: Optional[str] = ...) -> str: ...
